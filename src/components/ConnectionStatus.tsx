...
export default function ConnectionStatus({ state }: ConnectionStatusProps) {
  ...
  return (
    <div className="fixed top-3 right-3 flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/50 text-white text-sm font-medium z-50" data-testid="connection-status">
